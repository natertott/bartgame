...
#ifdef QUICKSTART
    [ITEM_SKILL_SPIN_ATTACK] = { 500, 0, TEXT_INDEX(TEXT_STOCKWELL, 0x02), TEXT_INDEX(TEXT_ITEM_GET, 0x48) },
#else
...
#ifdef QUICKSTART
    [ITEM_HEART_PIECE] = { 300, 0, TEXT_INDEX(TEXT_STOCKWELL, 0x02), TEXT_INDEX(TEXT_ITEM_GET, 0x18) },
    [ITEM_WALLET] = { 350, 0, TEXT_INDEX(TEXT_STOCKWELL, 0x04), TEXT_INDEX(TEXT_ITEM_GET, 0x64) },
#else
