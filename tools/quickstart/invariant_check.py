...
FLAG_FAMILIES = [
    ...
    ('GF_HANDICAP_', 11, 0),
    ('GF_HUNT_', 11, 0),
    ('GF_STEALTH_', 11, 0),  # F2, in the run the extension slots gave back
...
def emu_gfx_budget(rom):
    ...
    """
    from emu import boot, warp, here, qs_set, GENT, STRIDE, MAX_ENT, poison_here
...
def emu_rooms(rom, start, end):
    from emu import boot, warp, here, room_dims, coll_at, qs_set, qs_site_set, GENT, STRIDE, MAX_ENT, r16, poison_here
