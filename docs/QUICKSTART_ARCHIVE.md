# QUICKSTART Archive (stashed roadmap, pre-reassessment)

Stashed on 2026-08-14 when the roadmap was streamlined for the forward-direction
reassessment. This file preserves, verbatim, the last full version of the old
roadmap: the completed-work log, the architecture reference (sections 3.x), the
phase histories, and every DONE bug writeup. Code comments that cite
"docs/QUICKSTART_ROADMAP.md sec N" refer to the section numbering in THIS file.
The live, forward-looking roadmap is docs/QUICKSTART_ROADMAP.md.
